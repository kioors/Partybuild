...
public interface IMemberService extends IBaseService<Member, Long> {
     ...
     * @param gender
     */
    void register(String nickname, Gender gender);
     ...
     * @param name
     */
    void updateMobileAndName(MemberModel memberModel, String mobile, String name);
    ...
    MemberModel putMemberToCache(Member member);
