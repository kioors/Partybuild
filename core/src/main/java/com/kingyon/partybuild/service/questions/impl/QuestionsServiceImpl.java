...
public class QuestionsServiceImpl extends BaseService<Question, Long> implements IQuestionsService {
    ...
    public List<ApiKnowledgeQuestionsResponse> getKnowledgeQuestions(long uid) {
        ...
        int questionCount = questionsRepository.findCount(PaperType.KNOWLEDGEBREAK.getType());
        int page = questionCount % 2000 > 500 ? (questionCount / 2000) + 1 : questionCount / 2000;

        Pageable pageable = new PageRequest(1, 200, Sort.Direction.DESC, "id");
        ...
        System.out.println(questionsSets.size());
        System.out.println("=================================");
